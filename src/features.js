...
export const FEATURES = [
  ...
  { iconName: 'IconPalette', title: 'استایل و افکت متن', text: 'متن قوسی، موجی و دایره‌ای، سایهٔ سه‌بعدی، ماسک تصویر، کشیده، گرادیان، نئون و جعبه‌های متن نقل‌قول، مک و توییت.' },
  ...
  { iconName: 'IconSliders', title: 'کنترل کامل چیدمان', text: 'اندازه‌ی فونت، فاصله‌ی حروف و خطوط، چیدمان و نسبت‌های ابعاد استوری ۹:۱۶، کاروسل ۳:۴، مربعی و بنر ۳:۱.' },
