...
> [!NOTE]
> 🔒 **حریم خصوصی:** متن، طرح‌های ذخیره‌شده، تنظیمات و فونت‌های شخصی شما فقط روی مرورگر یا حافظه دستگاه شما ذخیره می‌شوند (`localStorage` و حافظه محلی) و به سرور ارسال نمی‌شوند. برای سنجش استفاده و علاقه‌مندی به فونت‌ها، فقط آمار ناشناس بازدید، انتخاب فونت و لایک با امکان غیرفعال‌سازی ثبت می‌شود.
