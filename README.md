...
├── src/
│   ├── main.jsx           # نقطه ورود و روتینگ
│   ├── index.css          # توکن‌های پایه عمومی
│   ├── app/               # ادیتور (#/app)
│   ├── landing/           # لندینگ + features.js
│   ├── share/             # پک اشتراک‌گذاری
│   ├── stats/             # داشبورد آمار
│   └── shared/            # fonts, strings, native, updates, icons
├── package.json           # وابستگی‌ها و اسکریپت‌های پروژه
└── vite.config.js         # پیکربندی ابزار بیلد Vite 8
```

جزئیات بیشتر: [`src/README.md`](src/README.md).
...
### 🌐 چندزبانه بودن (i18n)
تمام رشته‌های متنی در فایل [`src/shared/strings.js`](src/shared/strings.js) نگهداری می‌شوند. در صورت تمایل به افزودن زبان جدید:
1. آبجکت جدید زبان (مثلاً `ar`) را ایجاد کرده و تمامی کلیدهای موجود را ترجمه کنید.
2. دکمه زبان جدید را در بخش تنظیمات [`src/app/App.jsx`](src/app/App.jsx) اضافه کنید.
